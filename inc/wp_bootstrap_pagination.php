...
function industry_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'industry' ),
        'next_string'     => esc_html__( '&raquo;', 'industry' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'industry_pagination_defaults', $defaults )
    );
