...
class industry_author_widget extends WP_Widget {
...
'industry_author_widget', 


// Widget name will appear in UI
esc_html__( '[ Industry ] Author Widget', 'industry-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'industry-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'industry-companion' );
}
...
?>
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:' ,'industry-companion'); ?></label> 
<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
</p>

<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'industry-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'industry-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'industry-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'industry-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'industry-companion'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'industry-companion' ); ?>:</label>
	<div class="industry-media-container">
		<div class="industry-media-inner">
			...
			<span class="industry-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'industry-companion' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="industry-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'industry-companion' ); ?>" class="button industry-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'industry-companion' ) : __( 'Select Image', 'industry-companion' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button industry-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.industry-media-container {
	width: 98%;
}
...
.industry-media-remove {
	float: left;
	width: 48%;
}

.industry-media-upload {
	float: right;
	width: 48%;
}
</style>
...
jQuery(function($){
    ...
    wpshed_image_upload( '.industry-media-upload' );
    ...
    wpshed_image_remove( '.industry-media-remove' );
...
} // Class industry_author_widget ends here


// Register and load the widget
function industry_author_load_widget() {
	register_widget( 'industry_author_widget' );
}
add_action( 'widgets_init', 'industry_author_load_widget' );