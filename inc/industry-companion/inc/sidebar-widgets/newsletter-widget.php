...
class industry_newsletter_widget extends WP_Widget {
...
'industry_newsletter_widget',


// Widget name will appear in UI
esc_html__( '[ Industry ] Newsletter Form', 'industry-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'industry-companion' ), ) 
);
...
?>
<div id="mc_embed_signup" class="industry-subscribe-newsletter newsletter-form">
	<form target="_blank" novalidate action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post" class="navbar-form">
		...
		<input type="email" name="EMAIL" class="form-control" placeholder="<?php esc_html_e( 'Email address', 'industry-companion' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Newsletter', 'industry-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'industry-companion'); ?></label> 
...
} // Class industry_newsletter_widget ends here


// Register and load the widget
function industry_newsletter_load_widget() {
	register_widget( 'industry_newsletter_widget' );
}
add_action( 'widgets_init', 'industry_newsletter_load_widget' );