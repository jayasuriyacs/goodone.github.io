...
class industry_social_widget extends WP_Widget {
...
'industry_social_widget', 


// Widget name will appear in UI
esc_html__( '[ Industry ] Social Widget', 'industry-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'industry-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'industry-companion' );
}
...
} // Class industry_social_widget ends here


// Register and load the widget
function industry_social_load_widget() {
	register_widget( 'industry_social_widget' );
}
add_action( 'widgets_init', 'industry_social_load_widget' );