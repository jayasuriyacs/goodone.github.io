...
class Industry_Enqueue {

	public $scripts = array();

	public function industry_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'industry_frontend_enqueue_scripts', ) );
	}

	public function industry_frontend_enqueue_scripts( ) {
