...
// image default alt
if( ! function_exists( 'industry_img_default_alt' ) ) {
	function industry_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'industry_img_tag' ) ) {
	function industry_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = industry_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'industry_anchor_tag' ) ) {
	function industry_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'industry' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'industry_heading_tag' ) ) {
	function industry_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'industry' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'industry_paragraph_tag' ) ) {
	function industry_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'industry_other_tag' ) ) {
	function industry_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'industry_button_element ' ) ) {
	function industry_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'industry' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
