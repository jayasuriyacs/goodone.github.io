...
function industry_common_custom_css() {
    ...
    wp_enqueue_style( 'industry-common', get_template_directory_uri().'/assets/css/common.css' );
		...
		$navbarbg 		   = esc_attr( industry_opt( 'industry_header_navbar_bgColor' ) );
		$stickynavbarbg    = esc_attr( industry_opt( 'industry_header_navbarsticky_bgColor' ) );
		$navmenuColor 			= esc_attr( industry_opt( 'industry_header_navbar_menuColor' ) );
		$navmenuHovColor 		= esc_attr( industry_opt( 'industry_header_navbar_menuHovColor' ) );
		$stickynavmenuColor 	= esc_attr( industry_opt( 'industry_header_sticky_navbar_menuColor' ) );
		$stickynavmenuHovColor 	= esc_attr( industry_opt( 'industry_header_sticky_navbar_menuHovColor' ) );
		$foftext1     	   = esc_attr( industry_opt( 'industry_fof_textonecolor_settings' ) );
		$foftext2     	   = esc_attr( industry_opt( 'industry_fof_texttwocolor_settings' ) );
		$fofbgcolor        = esc_attr( industry_opt( 'industry_fof_bgcolor_settings' ) );
		$footerbgColor     = esc_attr( industry_opt( 'industry_footer_bgColor_settings' ) );
		$footerTextColor   = esc_attr( industry_opt( 'industry_footer_color_settings' ) );
		$anchorcolor 	   = esc_attr( industry_opt( 'industry_footer_anchorcolor_settings' ) );
		$anchorhovcolor    = esc_attr( industry_opt( 'industry_footer_anchorhovcolor_settings' ) );
		$widgettitlecolor  = esc_attr( industry_opt( 'industry_footer_widgettitlecolor_settings' ) );
		$themecolor  	   = esc_attr( industry_opt( 'industry_themecolor' ) );
		$lefttextcolor	   = esc_attr( industry_opt( 'industry_header_lefttext' ) );
    ...
    wp_add_inline_style( 'industry-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'industry_common_custom_css', 50 );